...
csv_file_path = 'euro_stoxx_50_links.csv'

# Folder where you want to save the downloaded files
download_folder = '/Users/jonathanzeh/Library/CloudStorage/OneDrive-Personal/RStudio/BA_Thesis/euro_stoxx_50_downloads'
...
with open(csv_file_path, 'r') as file:
    ...
    for row in csv_reader:
        ...
        file_name = f"euro_stoxx_50_{date_str}.csv"
