...
ek.set_app_key('762174b9ba374454be2c7c81207199ab6e29305a')
...
file_path = "D:\\30_One_Drive_Jonathan\\OneDrive\\BA_Thesis\\BA_coding\\datasets\\eikon_data\\fund_holdings_data\\etf_holdings_600_stocks_2020_01_2020_12.csv"
...
def fetch_data(value, sdate_for_year, max_retries=3):
    ...
    while attempts < max_retries:
        try:
            ...
            attempts += 1  # Break on non-HTTP, non-request errors to avoid infinite loop
