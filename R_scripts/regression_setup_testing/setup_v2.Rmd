...
annual_mean_df_outstanding <- annual_mean_function(df_outstanding)
# View the result
...
monthly_mean <- df_clean %>%
  ...
  summarize(mean_shares_outstanding = 
            ...
            mean_market_cap = weighted.mean(ETF_ownership, market_cap, 
                                            na.rm = TRUE),
            FUND_mean_shares_outstanding =
              weighted.mean(FUND_percent_of_traded_shares,
                            market_cap, na.rm = TRUE),
